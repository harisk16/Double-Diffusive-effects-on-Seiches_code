...
for fi=1:mylen
	...
	colormap darkjet
	subplot(3,3,fi);
	pcolor(x1dv,z1dv(1:199),diss_top'),shading flat,caxis(subplot(3,3,fi),[-6 6]);
	if fi == 1 | fi == 4 | fi == 7
		ylabel('z (m)')
	end
	if fi == 7 | fi == 8 | fi == 9
...
print(fig,'-djpeg',sprintf('../harishankar_matlab/Plots/diss_vorty/diss_bot_time_12_to_28s.jpg'))
